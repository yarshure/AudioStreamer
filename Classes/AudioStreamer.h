...
// pur
#include "PureCodec.h"
#define kAudioFilePUREType 1979
...
// pur
    ...
    struct PURE_HEADER pure_header   ;

    int frame_bytes;//int32
    int durationMS;

    BYTE  frame_buffer[644];    // frame input

    AudioFileTypeID fileTypeHint;
    
    BOOL reConnect;
    FILE * fpIN ;//play localfile
    BOOL isfile;
    int reconnectTimes;
    
    NSDate *lastRecivedTime;
}
